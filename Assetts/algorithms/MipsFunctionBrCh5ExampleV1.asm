#  COMSC210 Lab Assignment 4 A - MIPS Assembly Language Function Call
# 
#
#  In the textbook Assembly Language Programming
#   Pages 42 - 47 provide a suggested minimal documentation standard and an example program
#   
#  The main components of the documentation standard are as follows:
#
...
#
#	In class exercise:  Enter and document the example program from pages 42 - 47 using the 
#  documentation standards and code below. 
#  Submit 
